...
ActiveRecord::Schema.define(version: 20170928020812) do
  ...
  create_table "poems", force: :cascade do |t|
    ...
    t.index ["title"], name: "index_poems_on_title"
  end
  ...
  create_table "poets", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_poets_on_name", unique: true
  end
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["annotation_id", "user_id"], name: "index_votes_on_annotation_id_and_user_id", unique: true
  end
